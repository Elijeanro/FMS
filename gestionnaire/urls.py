...
# Les créations
    ...
    path('create/t-card/',views.create_t_card, name = 'create_t_card'),
...
# Les Modifications
    ...
    path('option/t_card/', views.option_t_card, name='option_t_card'),
    path('update/t_card/<int:pk>/<str:action>/', views.update_t_card, name='update_t_card'),
    path('edit/t_card/<int:pk>/', views.edit_t_card, name='edit_t_card'),
...
# Autocomplete
    # path('autocompletion/marque/', views.autocomplete_marque, name='autocomplete_marque'),
    # path('autocompletion/immatriculation/', views.autocomplete_immatriculation, name='autocomplete_immatriculation'),
    # path('autocompletion/type_engin/', views.autocomplete_type_engin, name='autocomplete_type_engin'),
    # path('autocompletion/type_maintenance/', views.autocomplete_type_maintenance, name='autocomplete_type_maintenance'),
    # path('autocompletion/fournisseur/', views.autocomplete_fournisseur, name='autocomplete_fournisseur'),
    # path('autocompletion/modele/', views.autocomplete_modele, name='autocomplete_modele'),
    # path('autocompletion/conducteur/', views.autocomplete_conducteur, name='autocomplete_conducteur'),
]